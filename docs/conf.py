...
intersphinx_mapping = {
    ...
    'test-graph': ['https://superzerg.github.io/sphinxcontrib-traceables/test-graph/', './build/test-graph/objects.inv'],
...
if os.getenv('TRAVIS') != True:
    intersphinx_mapping['constellations'][1] = 'https://superzerg.github.io/sphinxcontrib-traceables/constellations/objects.inv'
    intersphinx_mapping['requirements'][1] = 'https://superzerg.github.io/sphinxcontrib-traceables/requirements/objects.inv'
    intersphinx_mapping['test-graph'][1] = 'https://superzerg.github.io/sphinxcontrib-traceables/test-graph/objects.inv'
    intersphinx_mapping['test-list'][1] = 'https://superzerg.github.io/sphinxcontrib-traceables/test-list/objects.inv'
    intersphinx_mapping['test-matrix'][1] = 'https://superzerg.github.io/sphinxcontrib-traceables/test-matrix/objects.inv'
